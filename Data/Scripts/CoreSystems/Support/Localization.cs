        ...
        private static readonly Dictionary<MyLanguagesEnum, Dictionary<string, string>> I18NDictionaries =
            new Dictionary<MyLanguagesEnum, Dictionary<string, string>>
            {
                ...
                },
               {
                    ...
                    {
                        { "Guidance Toggle On/Off", "Вкл. / Выкл. Нацеливание" },
                        { "Guidance On", "Нацеливание Вкл" },
                        { "Guidance Off", "Нацеливание Выкл" },
                        { "Increase Weapon Damage", "Увеличение урона оружия" },
                        { "Decrease Weapon Damage", "Уменьшить урон оружия" },
                        { "Increase Weapon ROF", "Увеличение скорострельности оружия" },
                        { "Decrease Weapon ROF", "Уменьшить скорострельность оружия" },
                        { "Overload Toggle On/Off", "Переключатель перегрузки Вкл. / Выкл." },
                        { "Overload On", "Перегрузка Вкл." },
                        { "Overload Off", "Перегрузка Выкл." },
                        { "TerminalSwitchOn", "Вкл." },
                        { "TerminalSwitchOff", "Выкл." },
                        { "TerminalGuidanceTitle", "Включить Нацеливание" },
                        { "TerminalGuidanceTooltip", "Включить Нацеливание" },
                        { "TerminalWeaponDamageTitle", "Изменить урон за выстрел" },
                        { "TerminalWeaponDamageTooltip", "Изменить урон за выстрел" },
                        { "TerminalWeaponROFTitle", "Изменить скорострельность" },
                        { "TerminalWeaponROFTooltip", "Изменить скорострельность" },
                        { "TerminalOverloadTitle", "Ущерб от перегрузки" },
                        { "TerminalOverloadTooltip", "Ущерб от перегрузки" },
                        { "TerminalDetonationTitle", "Время детонации" },
                        { "TerminalDetonationTooltip", "Время детонации" },
                        { "TerminalStartCountTitle", "Начать обратный отсчет" },
                        { "TerminalStartCountTooltip", "Начать обратный отсчет" },
                        { "TerminalStopCountTitle", "Остановить обратный отсчет" },
                        { "TerminalStopCountTooltip", "Остановить обратный отсчет" },
                        { "TerminalArmTitle", "Вооруженная боеголовка" },
                        { "TerminalArmTooltip", "Если этот флажок установлен, боеголовка может быть взорвана вручную или неосторожным обращением." },
                        { "TerminalTriggerTitle", "Курок" },
                        { "TerminalTriggerTooltip", "Курок" },
                        { "TerminalWeaponRangeTitle", "Радиус прицеливания" },
                        { "TerminalWeaponRangeTooltip", "Измените минимальный / максимальный диапазон нацеливание" },
                        { "TerminalNeutralsTitle", "Нацеливание на нейтралы" },
                        { "TerminalNeutralsTooltip", "Стрельба по нейтральным целям" },
                        { "TerminalUnownedTitle", "Нацеливание на без владельца" },
                        { "TerminalUnownedTooltip", "Стрельба по целям без владельца" },
                        { "TerminalBiologicalsTitle", "Нацеливание на биологические" },
                        { "TerminalBiologicalsTooltip", "Огонь по игрокам и биологическим NPC" },
                        { "TerminalProjectilesTitle", "Нацеливание на снаряды" },
                        { "TerminalProjectilesTooltip", "Огонь по входящим снарядам" },
                        { "TerminalMeteorsTitle", "Нацеливание на метеоры" },
                        { "TerminalMeteorsTooltip", "Нацеливание на метеоры" },
                        { "TerminalGridsTitle", "Нацеливание на сетки" },
                        { "TerminalGridsTooltip", "Нацеливание на сетки" },
                        { "TerminalFocusFireTitle", "Нацеливание с фокусом" },
                        { "TerminalFocusFireTooltip", "Сосредоточить весь огонь на указанной цели" },
                        { "TerminalSubSystemsTitle", "Нацеливание на подсистемы" },
                        { "TerminalSubSystemsTooltip", "Нацеливание на подсистемы объекта" },
                        { "TerminalRepelTitle", "Режим Отталкивания" },
                        { "TerminalRepelTooltip", "Активно сосредотачиваться и отражать небольшие угрозы" },
                        { "TerminalPickAmmoTitle", "Подобрать боеприпасы" },
                        { "TerminalPickAmmoTooltip", "Выберите тип боеприпасов для использования" },
                        { "TerminalPickSubSystemTitle", "Выбрать подсистему" },
                        { "TerminalPickSubSystemTooltip", "Выберите целевую подсистему, на которой нужно сосредоточить огонь" },
                        { "TerminalTrackingModeTitle", "Режим слежения" },
                        { "TerminalTrackingModeTooltip", "Требования к управлению движением огня" },
                        { "TerminalControlModesTitle", "Режим управления" },
                        ...
                        { "TerminalCameraChannelTooltip", "Назначьте это оружие каналу камеры" },
                        { "TerminalTargetGroupTitle", "Целевая ведущая группа" },
                        { "TerminalTargetGroupTooltip", "Назначьте это оружие ведущей целевой группе" },
                        { "TerminalDecoyPickSubSystemTitle", "Выбрать подсистему" },
                        ...
                        { "TerminalCameraCameraChannelTooltip", "Назначьте канал оружия камеры для этой камеры" },
                        { "TerminalDebugTitle", "Отлаживать" },
                        { "TerminalDebugTooltip", "Отладка Вкл. / Выкл." },
                        { "TerminalShootTitle", "Стрелять" },
                        { "TerminalShootTooltip", "Вкл. / Выкл Стрелять" },
                        { "ActionStateOn", "Вкл." },
                        { "ActionStateOff", "Выкл." },
                        { "ActionWC_Shoot_Click", "Переключить щелчок, чтобы стрелять" },
                        { "ActionShootOnce", "Выстрелить один раз" },
                        { "ActionShoot", "Вкл. / Выкл. Стрелять" },
                        { "ActionShoot_Off", "Стрелять Выкл." },
                        { "ActionShoot_On", "Стрелять Вкл." },
                        { "ActionSubSystems", "Цикл подсистем" },
                        { "ActionNextCameraChannel", "Следующий канал" },
                        { "ActionPreviousCameraChannel", "Предыдущий канал" },
                        { "ActionControlModes", "Режим управления" },
                        { "ActionNeutrals", "Нейтральные Вкл/Выкл" },
                        { "ActionProjectiles", "Снаряды Вкл/Выкл" },
                        { "ActionBiologicals", "Биологические Вкл/Выкл" },
                        { "ActionMeteors", "Метеоры Вкл/Выкл" },
                        { "ActionGrids", "Сетки Вкл/Выкл" },
                        { "ActionFriendly", "Дружелюбние Вкл/Выкл" },
                        { "ActionUnowned", "Нет владельца Вкл/Выкл" },
                        { "ActionFocusTargets", "Цели фокуса Вкл/Выкл" },
                        { "ActionFocusSubSystem", "Нацеливание на подсистемы Вкл/Выкл" },
                        { "ActionMaxSizeIncrease", "Увеличение максимального размера" },
                        { "ActionMaxSizeDecrease", "Уменьшение максимального размера" },
                        { "ActionMinSizeIncrease", "Увеличение минимального размера" },
                        { "ActionMinSizeDecrease", "Уменьшение минимального размера" },
                        { "ActionTrackingMode", "Режим слежения" },
                        { "ActionWC_CycleAmmo", "Цикл расходных материалов" },
                        { "ActionWC_RepelMode", "Режим Отталкивания" },
                        { "ActionWC_Increase_CameraChannel", "Следующий канал камеры" },
                        { "ActionWC_Decrease_CameraChannel", "Предыдущий канал камеры" },
                        { "ActionWC_Increase_LeadGroup", "Следующая ведущая группа" },
                        { "ActionWC_Decrease_LeadGroup", "Предыдущая ведущая группа" },
                        { "ActionMask", "Выберите тип маски" },
                        { "SystemStatusFault", "[Ошибка]" },
                        { "SystemStatusOffline", "[Выкл.]" },
                        { "SystemStatusOnline", "[Вкл.]" },
                        { "SystemStatusRogueAi", "[Неизвестный ИИ] Детали без собственности!!" },
                        { "WeaponInfoConstructDPS", "Построить ДПС" },
                        { "WeaponInfoShotsPerSec", "Выстрелов в секунду" },
                        { "WeaponInfoRealDps", "Реальный ДПС" },
                        { "WeaponInfoPerfectDps", "Идеальный ДПС" },
                        { "WeaponInfoPeakDps", "Пиковый ДПС" },
                        { "WeaponInfoBaseDps", "Базовый ДПС" },
                        { "WeaponInfoAreaDps", "Площадь ДПС" },
                        { "WeaponInfoExplode", "Взорваться" },
                        { "WeaponInfoCurrent", "Текущий" },
                        { "WeaponInfoHeatGenerated", "Вырабатываемое тепло" },
                        { "WeaponInfoHeatDissipated", "Рассеиваемое тепло" },
                        { "WeaponInfoCurrentHeat", "Текущее тепло" },
                        { "WeaponInfoCurrentDraw", "Текущая потребляемая мощность" },
                        { "WeaponInfoRequiredPower", "Требуемая мощность" },
                        { "WeaponInfoDividerLineWeapon", "==== Оружие ====" },
                        { "WeaponInfoName", "Имя" },
                        { "WeaponInfoBurst", "Серийный" },
                        { "WeaponInfoDelay", "Задерживать" },
                        { "WeaponInfoReloading", "Перезарядить" },
                        { "WeaponInfoLoS", "Поле зрения" }
                    }
                },
                {
