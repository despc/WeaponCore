...
namespace CoreSystems.Platform
{
    public partial class Weapon
    {
        public class WeaponComponent : CoreComponent
        {
            ...
            internal void UpdateBurst(Weapon w)
            {
            ...
            internal void RequestShootBurst(long playerId)
            {
                ...
                RequestShootBurstId = state.ShootBurstStateId + 1;
            ...
            internal void DetectStateChanges()
            {
                ...
                if (IsDisabled) {
                    RequestShootBurstId = Data.Repo.Values.State.ShootBurstStateId;
                    WeaponsFired = 0;
                }
            ...
            internal static void ResetCompState(WeaponComponent comp, long playerId, bool resetTarget, bool resetState, Dictionary<string, int> settings = null)
            {
                ...
                comp.RequestShootBurstId = comp.Data.Repo.Values.State.ShootBurstStateId;
                comp.WeaponsFired = 0;
